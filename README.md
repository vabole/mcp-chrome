...
- 🎯 **Token-Efficient Responses**: YAML-based responses save 2-45% tokens compared to JSON for better LLM performance
...
- [Token Efficiency Analysis](docs/TOKEN_EFFICIENCY_ANALYSIS.md) - YAML vs JSON performance comparison
